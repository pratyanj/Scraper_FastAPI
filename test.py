...
# track_id = 3695200023186
    def scrapedata(self,id):
        ...
        for i in range(1, num_rows):
            ...
            # return tracking_id["tracking_info"]

       

        # # print(tracking_id["tracking_info"]["ti_u_2"])

        # print(Delivery_Information)
        # print(Delivery_Information)
        
  
        # r_json = json.dumps(all_data)
        
        return all_data
        # return print(tracking_id)
...
# track.scrapedata(3695200023187)
        ...
        # # print("************************************")
        # # printing Delivery_Information dictionary
        # for key, value in Delivery_Information.items():
        #     print(key + ": " + value)
        # print("************************************")